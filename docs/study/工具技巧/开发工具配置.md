...
访问 IDEA 官网：https://www.jetbrains.com/idea/download/ ，下载 IDEA 2025.2 版本的安装包：

![下载 IDEA 2025.2 版本安装包](https://img.quanxiaoha.com/quanxiaoha/175435720263219)下载 IDEA 2025.2 版本安装包

#### 开始安装

下载完成后，安装步骤如下图所示 :

![IDEA 2025.2 安装步骤](https://img.quanxiaoha.com/quanxiaoha/174502512804671)IDEA 2025.2 安装步骤

1. 双击 `.exe` 安装包开始安装 IDEA；
2. 自定义 IDEA 的安装路径，这里我选择安装在了 `E:/` 盘下，点击**下一步**按钮；
3. **勾选创建桌面快捷方式**，点击**下一步**按钮；
4. 点击**安装**按钮；
5. 等待安装成功...；
6. 安装成功后，**先不要勾选运行 IDEA**, 直接点击**完成**按钮，完毕弹框，准备开始进入破解步骤；

#### 下载破解脚本

> 脚本下载链接：https://pan.baidu.com/s/1xkvtuaQcC4iQhm96w3-8VA?pwd=tvcg

下载成功后，是个压缩包，将它**解压到一个路径中没有 “中文”，“空格” 的位置**，我这里解压到了 `E:\pojie\jetbra-pojie`, 注意一定要这么做，不然会导致破解失败！！！

解压成功后，内容如下：

![JetBrains 全家桶激活脚本](https://img.quanxiaoha.com/quanxiaoha/174502565762043)JetBrains 全家桶激活脚本
...
![执行破解脚本](https://img.quanxiaoha.com/quanxiaoha/174502655335191)执行破解脚本
...
![破解成功，会提示 Done](https://img.quanxiaoha.com/quanxiaoha/166610151900684)破解成功，会提示 Done
...
![img](https://img.quanxiaoha.com/quanxiaoha/173081032984939)

如果是老用户，则可以在 `Settings` 设置菜单中来更改（**一定要更改**）：

![img](https://img.quanxiaoha.com/quanxiaoha/173094760241964)

点击 `Activate License` 按钮，开始激活 IDEA，如下图：

![img](https://img.quanxiaoha.com/quanxiaoha/174502710591032)
