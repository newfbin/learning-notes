...
![在这里插入图片描述](./assets/04.三种特殊数据类型/5ee5e64f5a3b55183c7307400995d23e.png)看来距离计算还是比较靠谱，还不是那么精确。
...
![在这里插入图片描述](./assets/04.三种特殊数据类型/b98a0c8bb3515edd3644e7177a928c7a.png)
...
![在这里插入图片描述](./assets/04.三种特殊数据类型/a628fe8b34139c2bae534268b9dc109c.png)
