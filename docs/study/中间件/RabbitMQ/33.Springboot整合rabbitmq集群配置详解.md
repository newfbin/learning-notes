...
![img](./assets/33.Springboot整合rabbitmq集群配置详解/kuangstudy1433dcb6-80f9-4592-a57e-2cbb15863fb8.png)

3 Spring AMQP的主要对象
注：如果不了解AMQP请前往官网了解.

![img](./assets/33.Springboot整合rabbitmq集群配置详解/kuangstudyba7682ed-fc98-4948-b12e-229c5381d3c0.png)
