...
>
> 假设我们希望为用户提供一个[Markdown](https://baike.baidu.com/item/MarkDown)文本转换为HTML和Word的服务.
>
> `AbstractFactory`对应上图中的Factory， `HtmlDocument`对应上图中的ProductA，`WordDocument`对应上图中的ProductB
>
> `FastFactory`对应上图中的Factory1，`FastHtmlDocument`对应上图中的ProductA1，`FastWordDocument`对应上图中的ProductA2
>
> `GoodFactory`对应上图中的Factory2，`GoodHtmlDocument`对应上图中的ProductB1，`GoodWordDocument`对应上图中的ProductB2
...
![abstract-factory](./assets/02.抽象工厂模式/abstract-factory.png)
