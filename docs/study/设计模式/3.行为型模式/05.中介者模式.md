...
![order](./assets/05.中介者模式/order.png)
...
class OrderFrame extends JFrame {
    public OrderFrame(String... names) {
        ...
        List<JCheckBox> checkboxList = addCheckBox(names);  // 多选框
        JButton selectAll = addButton("Select All");  	    // “选择全部”按钮
        JButton selectNone = addButton("Select None"); 	    // "取消所有"按钮
        selectNone.setEnabled(false);  					  // “反选”按钮
...
![mediator](./assets/05.中介者模式/mediator.png)
