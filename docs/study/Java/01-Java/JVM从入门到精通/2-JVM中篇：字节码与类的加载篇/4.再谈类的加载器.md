...
![image-20210501102535142](./assets/4.再谈类的加载器/fb51cabb2218d857a809a59918c5beec.png)
...
![image-20210501164413665](./assets/4.再谈类的加载器/0c43fb4a7da20038c8f56b42a1ddf802.png)
...
- 加载扩展类和应用程序类加载器，并指定为他们的父类加载器。
  ...
  ![image-20210501170011811](./assets/4.再谈类的加载器/43431a1abff0e5f2bd7bfd20fe91e5f7.png)
  ![image-20210501170038212](./assets/4.再谈类的加载器/5cd73234cd993408846ec7b4c2cb7238.png)
...
**执行结果：**
![image-20210501170425889](./assets/4.再谈类的加载器/c72286acf05c7f86d1ea24f74e0c2a1e.png)
...
- 从java.ext.dirs系统属性所指定的目录中加载类库，或从JDK的安装目录的jre/lib/ext子目录下加载类库。如果用户创建的JAR放在此目录下，也会自动由扩展类加载器加载。
  ...
  ![在这里插入图片描述](./assets/4.再谈类的加载器/ba54af96e744eb99a9248d13e55a7e3c.png)
...
**执行结果：**
  ...
  ![img](./assets/4.再谈类的加载器/b21313ee65acb4f01f1d03b88529e9f5.png)
...
![image-20210501171206453](./assets/4.再谈类的加载器/19dd9595afeb6543593ef14161fc1bb8.png)
...
![image-20210501173110637](./assets/4.再谈类的加载器/00148a792adcf05932114dff408f82b5.png)
...
![image-20210501174730756](./assets/4.再谈类的加载器/53f634bada23b3400a303bfcc6e11a31.png)
...
![img](./assets/4.再谈类的加载器/a77b6bca10308e6b9be35b1b2dfc84bc.png)
...
![image-20210501175529542](./assets/4.再谈类的加载器/41cbfd9ba1da676a7f05dae0dac3abae.png)

![img](./assets/4.再谈类的加载器/c1526b63e95852b48551b4f136ebbd6f.png)
...
这并非是不可能出现的事情，一个典型的例子便是JNDI服务，JNDI现在已经是Java的标准服务，它的代码由启动类加载器来完成加载（在JDK 1.3时加入到rt.jar的），肯定属于Java中很基础的类型了。但JNDI存在的目的就是对资源进行查找和集中管理，它需要调用由其他厂商实现并部署在应用程序的ClassPath下的JNDI服务提供者接口（Service Provider Interface，SPI）的代码，现在问题来了，启动类加载器是绝不可能认识、加载这些代码的，那该怎么办？<u>（SPI：在Java平台中，通常把核心类rt.jar中提供外部服务、可由应用层自行实现的接口称为SPI）</u>
...
![img](./assets/4.再谈类的加载器/814235dcce5471c2a527e82bafcf21c7.png)
...
![image-20210501182003439](./assets/4.再谈类的加载器/9ae876265c85af4e431932647993dab7.png)
...
![image-20210501182608205](./assets/4.再谈类的加载器/71caf905a0ca13866e24419b7faa14ee.png)
...
![image-20210501182626963](./assets/4.再谈类的加载器/b93f0829e8340131a49738f8843307e4.png)

## 6.3. JDK1.2时期

在Java1.2版本中，再次改进了安全机制，增加了**代码签名**。不论本地代码或是远程代码，都会按照用户的安全策略设定，由类加载器加载到虚拟机中权限不同的运行空间，来实现差异化的代码执行权限控制。如下图所示JDK1.2安全模型：

![image-20210501182652378](./assets/4.再谈类的加载器/81919ed70977f2b57ef5a11481c68abc.png)
...
![image-20210501182740197](./assets/4.再谈类的加载器/cf22059daec45f370ae3afb33b870c1f.png)
...
![img](./assets/4.再谈类的加载器/323cfcda53f98034ed15372c0ea43685.png)
...
![img](./assets/4.再谈类的加载器/cb23791a5fb1bf1a4c8a28d6a3179e84.png)

![img](./assets/4.再谈类的加载器/ef9b83abcdb9f54d0f0ec7d15f0adc44.png)

![img](./assets/4.再谈类的加载器/192fda50804d35e7d1b44dc61a65ede1.png)

![img](./assets/4.再谈类的加载器/f07a455ec275a6503bfad070ae3d9ffb.png)
