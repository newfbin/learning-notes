...
+ 强类型语言与弱类型语言的比较
  ...
  - C# 从 4.0 开始引入了 Dynamic，让它可以利用动态语言的一些特性，但 C# 依然是强类型编程语言
    **要成为优秀的开发人员，软件、硬件、操作系统都要精通。**
    附上一张[后端工程师路线图.png](https://www.yuque.com/attachments/yuque/0/2019/png/101969/1557204253095-e6e7d4aa-71c0-4e11-96c5-7bfe5d9be488.png)（[来自 Github](https://github.com/kamranahmedse/developer-roadmap)）
