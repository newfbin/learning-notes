...
![image.png](./assets/第 1 期 - 实现方案和项目初始化/4d4a338a-1ec2-4225-9e48-9264bb9e6614.png)
...
![img](./assets/第 1 期 - 实现方案和项目初始化/3f45029c-a826-48da-a878-9253faec7583.png)

> 为啥要编译？ 因为有些语言不编译不能运行

![img](./assets/第 1 期 - 实现方案和项目初始化/c18837f1-139d-4cd3-ab2c-c5f06843636e.png)
...
![img](./assets/第 1 期 - 实现方案和项目初始化/e4dd0d06-1167-4d01-ab5c-ee77994ff931.png)
...
![img](./assets/第 1 期 - 实现方案和项目初始化/image-20230729125632846.png)
...
![img](./assets/第 1 期 - 实现方案和项目初始化/82f2a6a1-3945-42a1-90cf-3bcf2ed875eb.png)
...
![image.png](./assets/第 1 期 - 实现方案和项目初始化/9313f6db-067b-45e8-afc1-cd953efee39b.png)
...
![image.png](./assets/第 1 期 - 实现方案和项目初始化/37dc8844-0572-4e3d-a50a-da13f6e6cc0c.png)
...
![img](./assets/第 1 期 - 实现方案和项目初始化/119402cc-a78c-4576-8c71-26609d7c9f8c.png)
...
![image.png](./assets/第 1 期 - 实现方案和项目初始化/18b8ed78-9b48-4489-a020-4f47afa95743.png)
...
![image.png](./assets/第 1 期 - 实现方案和项目初始化/a1e4fd63-e78e-402e-9cd7-abfdf364a463.png)

登陆页面：

![image.png](./assets/第 1 期 - 实现方案和项目初始化/52ae3166-9c03-413c-bffc-ac276f5f47a0.png)

后端接口文档：

![image.png](./assets/第 1 期 - 实现方案和项目初始化/25c80d86-21e8-4a9a-b174-2ad0e625edca.png)
