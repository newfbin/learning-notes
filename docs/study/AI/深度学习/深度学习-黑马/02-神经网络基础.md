...
![image](assets/02-神经网络基础/image-20220313130303542.png)
...
![image](assets/02-神经网络基础/09.png)

![image](assets/02-神经网络基础/10.png)
...
![image](assets/02-神经网络基础/21.png)

激活函数求导公式：

![1663472645904](assets/02-神经网络基础/1663472645904.png)

sigmoid 激活函数的函数图像如下:

![image](assets/02-神经网络基础/25.png)
...
![image](assets/02-神经网络基础/23.png)

激活函数求导公式: 

![1663472675509](assets/02-神经网络基础/1663472675509.png)

Tanh的函数图像、导数图像如下：

![image](assets/02-神经网络基础/24.png)
...
![image](assets/02-神经网络基础/26.png)

激活函数求导公式: 

![1663472703595](assets/02-神经网络基础/1663472703595.png)

ReLU 的函数图像、导数图像如下：

![image](assets/02-神经网络基础/1734057447434.png)
...
![image](assets/02-神经网络基础/29.png)

![image](assets/02-神经网络基础/30.png)
...
- **随机初始化**
  ...
  - 均匀分布初始化：权重参数初始化从区间均匀随机取值，默认区间为（0，1）。可以设置为在(-$$1\over\sqrt{d}$$,$$1\over\sqrt{d}$$)均匀分布中生成当前神经元的权重，其中d为神经元的输入数量。
    ...
    ![1745673221974](assets/02-神经网络基础/1745673221974.png)
...
![image](assets/02-神经网络基础/image-20220313133601678.png)
...
- 模型参数的计算
  ...
  - 输入数据和网络权重是两个不同的事儿！对于初学者理解这一点十分重要，要分得清。
    ...
    ![image](assets/02-神经网络基础/image-20220313141138281.png)
...
![image-20200730153842351](assets/02-神经网络基础/03-1.png)

损失函数在不同的文献中名称是不一样的，主要有以下几种**命名方式**：

![image](assets/02-神经网络基础/03-2.png)
...
![image](assets/02-神经网络基础/03-3.png)
...
![image](assets/02-神经网络基础/03-4.png)

上图中的交叉熵损失为：

![image-20200730161024749](assets/02-神经网络基础/03-5.png)

从概率角度理解，我们的目的是最小化正确类别所对应的预测概率的对数的负值(损失值最小)，如下图所示：

![image](assets/02-神经网络基础/03-6.png)
...
![image-20200730162332710](assets/02-神经网络基础/03-7.png)
...
- L用来衡量真实值y与预测值$$\hat{y}$$之间差异性的损失结果。
  ...
  ![image](assets/02-神经网络基础/1735117379356.png)
...
![image-20200730165058491](assets/02-神经网络基础/03-8.png)

曲线如下图所示：

![image-20200730165142553](assets/02-神经网络基础/03-9.png)
...
![image-20200730165213969](assets/02-神经网络基础/03-10.png)

曲线如下图所示：

![image-20200730165404271](assets/02-神经网络基础/03-11.png)
...
![image-20200730170635889](assets/02-神经网络基础/03-12.png)

其中：`𝑥=f(x)−y` 为真实值和预测值的差值。

![image](assets/02-神经网络基础/03-13.png)
...
![image](G:/BaiduNetdiskDownload/%E6%B7%B1%E5%BA%A6%E5%AD%A6%E4%B9%A0%E8%AE%B2%E4%B9%89/%E6%B7%B1%E5%BA%A6%E5%AD%A6%E4%B9%A0%E5%9F%BA%E7%A1%80html/02-%E7%A5%9E%E7%BB%8F%E7%BD%91%E7%BB%9C%E5%9F%BA%E7%A1%80/assets/02-神经网络基础/13.png)
...
![image](assets/02-神经网络基础/image-20210129103846076.png)

**前向传播运算**：

![image](assets/02-神经网络基础/image-20210129104612230.png)
...
![image](assets/02-神经网络基础/image-20210129104646474.png)

导数（梯度）已经计算出来了，下面就是**反向传播与参数更新过程**：

![image](assets/02-神经网络基础/image-20210129104718140.png)

如果要想求**误差E对w1的导数**，误差E对w1的求导路径不止一条，这会稍微复杂一点，但换汤不换药，计算过程如下所示：

![image](assets/02-神经网络基础/image-20210129104756053.png)
...
![1735177998337](assets/02-神经网络基础/1735177998337.png)
...
![1734144867552](assets/02-神经网络基础/1734144867552.png)
...
![image-20220313172050673](assets/02-神经网络基础/04-01.png)

###  等间隔学习率衰减

等间隔学习率衰减方式如下所示：

![image](assets/02-神经网络基础/04-02.png)
...
![image](assets/02-神经网络基础/04-03.png)
...
![image](assets/02-神经网络基础/04-04.png)
...
![05-01](assets/02-神经网络基础/05-01.png)
...
![image-20220517141847967](assets/02-神经网络基础/image-20220517141847967.png)
...
![image-20220517143935599](assets/02-神经网络基础/image-20220517143935599.png)

先对数据标准化，再对数据重构（缩放+平移），写成公式如下所示：

![image](assets/02-神经网络基础/48.png)
...
![1745856376465](assets/02-神经网络基础/1745856376465.png)
...
![1734255905857](assets/02-神经网络基础/1734255905857.png)
...
![1734256199295](assets/02-神经网络基础/1734256199295.png)
...
![1734256384162](assets/02-神经网络基础/1734256384162.png)
