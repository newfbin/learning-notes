...
![image](assets/04-循环神经网络/1734745895344.png)
...
![image](assets/04-循环神经网络/1734746204314.png)
...
![image](assets/04-循环神经网络/1734747074293.png)
...
![RNN2](assets/04-循环神经网络/RNN2.gif)

我们举个例子来理解上图的工作过程，假设我们要实现文本生成，也就是输入 "我爱" 这两个字，来预测出 "你"，其如下图所示:

![image](assets/04-循环神经网络/02.png)

将上图展开成不同时间步的形式，如下图所示:

![image](assets/04-循环神经网络/03.png)
...
![image](assets/04-循环神经网络/05.png)

![image](assets/04-循环神经网络/1734749643694.png)
...
- **输出计算**：基于当前隐藏状态$$h_t$$，神经元生成当前时刻的输出$$y_t$$，该输出可以用于任务的最终预测。
  ...
  ![image](assets/04-循环神经网络/1735401373292.png)
...
![1735443424646](assets/04-循环神经网络/1735443424646.png)
...
![image](assets/04-循环神经网络/1734750013375.png)
...
![image](assets/04-循环神经网络/1734750711996.png)
...
- word_to_index: 存储了词到编号的映射
  ...
  ![image](assets/04-循环神经网络/1734751188623.png)
