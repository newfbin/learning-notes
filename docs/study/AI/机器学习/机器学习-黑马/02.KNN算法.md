...
![image-20230831143226786](./assets/KNN算法/image-20230831143226786.png)
...
![image-20230831143341119](./assets/KNN算法/image-20230831143341119.png)



![image-20230831143403932](./assets/KNN算法/image-20230831143403932.png)

![image-20230831143443988](./assets/KNN算法/image-20230831143443988.png)

![image-20230831143436328](./assets/KNN算法/image-20230831143436328.png)

![image-20230831143456524](./assets/KNN算法/image-20230831143456524.png)

![image-20230831143430741](./assets/KNN算法/image-20230831143430741.png)

![image-20230831143503916](./assets/KNN算法/image-20230831143503916.png)

![image-20230831143416184](./assets/KNN算法/image-20230831143416184.png)



### 【知道】K值的选择

![image-20260210213956466](./assets/02.KNN算法/image-20260210213956466.png)
...
![image-20230831145236097](./assets/KNN算法/image-20230831145236097.png)
...
![image-20230831145250261](./assets/KNN算法/image-20230831145250261.png)
...
![image-20260211141200946](./assets/02.KNN算法/image-20260211141200946.png)

### 【掌握】曼哈顿距离

![image-20260211141307317](./assets/02.KNN算法/image-20260211141307317.png)

### 【了解】切比雪夫距离

![image-20260211141345174](./assets/02.KNN算法/image-20260211141345174.png)
...
![image-20260211141413998](./assets/02.KNN算法/image-20260211141413998.png)
...
![image-20230831155159883](./assets/KNN算法/image-20230831155159883.png)

### 【掌握】归一化

通过对原始数据进行变换把数据映射到【mi,mx】(默认为[0,1])之间

![image-20230831155813699](./assets/KNN算法/image-20230831155813699.png)
...
![image-20230831160053298](./assets/KNN算法/image-20230831160053298.png)

* mean 为特征的平均值
* σ 为特征的标准差

> **方差**： 数据点 **平均离“均值”有多远（距离的平方）**
>
> **标准差**： 数据点 **平均离“均值”有多远（真实距离）**
>
> **公式的含义**：当前这个数据点，距离平均值有多少个“标准差”？
>
> - X′=0：刚好等于均值
> - X′=1：比均值大 1 个标准差
> - X′=−2：比均值小 2 个标准差
...
![](./assets/KNN算法/0_QHogxF9l4hy0Xxub.png)

每个花的特征用如下属性描述：

![](./assets/KNN算法/0_SHhnoaaIm36pc1bd.png)
...
![image-20230831163236810](./assets/KNN算法/image-20230831163236810.png)
...
5.若k=5 （划分为5份）模型得分最好，再使用全部训练集(训练集+验证集) 对k=5模型再训练一边，再使用测试集对k=5模型做评估



![image-20260211141624979](./assets/02.KNN算法/image-20260211141624979.png)

### 【知道】网格搜索

![image-20260211141856823](./assets/02.KNN算法/image-20260211141856823.png)

![image-20230910154650041](./assets/KNN算法/image-20230910154650041.png)

交叉验证网格搜索的API:

![image-20230831163636694](./assets/KNN算法/image-20230831163636694.png)
...
![image-20230831164024844](./assets/KNN算法/image-20230831164024844.png)
