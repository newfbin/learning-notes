...
![image-20210512144253383](./assets/13.垃圾回收器/ab10d1899d353ea14797f9ce1778503c.png)
...
![image-20200713083443486](./assets/13.垃圾回收器/6e2c2869a4450dc405bda0ea8a8e7c31.png)
...
![image-20200713084726176](./assets/13.垃圾回收器/a05d48c1926a03c3acdebf74d10bf522.png)
...
![image-20200713085306400](./assets/13.垃圾回收器/de90092e21cbff31926f7cc7dceebf25.png)
...
![image-20200713093551365](./assets/13.垃圾回收器/90c3bcdc22cd0b49e10d702c608c4fc6.png)
...
![image-20210512145950897](./assets/13.垃圾回收器/c529d76b22212c44275b94675cc56760.png)

### 13.2.3. 7 款经典收集器与垃圾分代之间的关系

![image-20200713093757644](./assets/13.垃圾回收器/fd16701d3e150d5e58d52b7306473a42.png)
...
![image-20200713094745366](./assets/13.垃圾回收器/b92c2212bea2907cb75ff9ef26f346fe.png)
...
![image-20200713100703799](./assets/13.垃圾回收器/d66b612e68381df2101c3e829a18b4f0.png)
...
![image-20200713102030127](./assets/13.垃圾回收器/187fdcd46a1cb35be6d88a01a433c0f3.png)
...
![image-20200713110359441](./assets/13.垃圾回收器/8a4b655ee277aaf0f9a46754248ce05a.png)
...
- `-XX:ParallelGCThreads` 设置年轻代并行收集器的线程数。一般地，最好与 CPU 数量相等，以避免过多的线程数影响垃圾收集性能。
  ...
  **当 `CPU_Count ≤ 8` 时**：
  ...
  - `ParallelGCThreads = CPU_Count`
    意味着并行垃圾回收线程的数量与系统的 CPU 核心数相同。

  **当 `CPU_Count > 8` 时**：

  - `ParallelGCThreads = 3 + (5 * CPU_Count / 8)`
    表示线程数量会随着 CPU 核心数的增加而非线性增长，但会受到限制，以避免线程数过多导致性能问题。
...
![image-20200713205154007](./assets/13.垃圾回收器/f84a132db8c56a488e14f51e2c4d7fa7.png)
...
![image-20200713212230352](./assets/13.垃圾回收器/052d6ef7655e46e040729082ac36da30.png)
...
![image-20200713215105293](./assets/13.垃圾回收器/9a71df3a4013da274aa3b28cd95e7d37.png)

![image-20200713215133839](./assets/13.垃圾回收器/8bcd36541731eb308043eba968b7a828.png)
...
![image-20200713223244886](./assets/13.垃圾回收器/74c611464ae6cdae3cbfffaef213cfd5.png)
...
![image-20200713223509993](./assets/13.垃圾回收器/049520c5a004b63f750e04d5362a2992.png)
...
![image-20200713224113996](./assets/13.垃圾回收器/e8f79c3cdeb0969981703f7a026cf581.png)
...
![image-20200713224716715](./assets/13.垃圾回收器/c97de4bdada1da5a9fdd344692ed0957.png)
...
![image-20200713225100632](./assets/13.垃圾回收器/f29fa4dfe3abf4a77be06fdf3378aecf.png)
...
![image-20200713225810871](./assets/13.垃圾回收器/766b882cba7e709202005a3baeb596d0.png)
...
![image-20200714080151020](./assets/13.垃圾回收器/5e57edaa3ec7295424480c67daee499e.png)
...
![image-20200714082555688](./assets/13.垃圾回收器/9364561fbb81a0e2f9aedc45a383972f.png)

### Full GC 日志

![image-20210512194815354](./assets/13.垃圾回收器/502793e725122b958f2861932e5ef9c1.png)
...
![image-20200714083332238](./assets/13.垃圾回收器/8dada6b73786eb693975593db10ce825.png)

![image-20200714083526790](./assets/13.垃圾回收器/78f6489bd1a3b74e14ee4a95392df8c2.png)
...
![image-20210512195426194](./assets/13.垃圾回收器/4aaef244379d75ba838e10d4178b2960.png)

现在 G1 回收器已成为默认回收器好几年了。

我们还看到了引入了两个新的收集器：ZGC（JDK11 出现）和 Shenandoah（Open JDK12）。主打特点：低停顿时间

![image-20210512195528695](./assets/13.垃圾回收器/00920e4ae2b2c80a8016e6d8f4632545.png)
...
![image-20200714090608807](./assets/13.垃圾回收器/01f566c0db04f0e475db05addd94259f.png)
...
![image-20210512200236647](./assets/13.垃圾回收器/f78eebadbabf7450ded984f0f1e3a405.png)
...
![image-20200714091201073](./assets/13.垃圾回收器/b08828b548a255493e934c6fe3308e50.png)

![image-20200714091401511](./assets/13.垃圾回收器/4e648c4e37d84f5d83d965b55f6bc5f9.png)
...
![image-20200714093243028](./assets/13.垃圾回收器/59b014ca2eeda5332fd40a4a2356f883.png)
...
![image-20200714093604012](./assets/13.垃圾回收器/835fff5c3a7884de2a1d564b7f332900.png)
