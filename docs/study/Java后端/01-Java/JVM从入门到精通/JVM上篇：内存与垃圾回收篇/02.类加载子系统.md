...
![image-20200705080719531](./assets/02.类加载子系统/e4bc9ed374db7f35e68f23f4813205bd.png)

![image-20250105161623741](./assets/02.类加载子系统/image-20250105161623741.png)
...
![image-20200705081813409](./assets/02.类加载子系统/3569bfb903e80b66ee7e972a6b4a5036.png)
...
![image-20200705081913538](./assets/02.类加载子系统/e8172076eaa7a152408633a353f06b2c.png)
...
![image-20200705082255746](./assets/02.类加载子系统/8cc54647114c456695ac352336c74600.png)

### 加载阶段

![image-20200705082601441](./assets/02.类加载子系统/a9497a1eeb7fae3022846b509186fdcd.png)
...
![image-20200705094149223](./assets/02.类加载子系统/1e553c6d5254f827d2dfab537bea3ab9.png)

这里的四者之间的关系是包含关系。不是上层下层，也不是子父类的继承关系。

**获取各个类加载器示例**：

![image-20250105170320898](./assets/02.类加载子系统/image-20250105170320898.png)

![image-20250105170301514](./assets/02.类加载子系统/image-20250105170301514.png)

![image-20250105170238973](./assets/02.类加载子系统/image-20250105170238973.png)
...
![image-20250105171200748](./assets/02.类加载子系统/image-20250105171200748.png)
...
![image-20250105171102844](./assets/02.类加载子系统/image-20250105171102844.png)
...
- 派生于 ClassLoader 类
- 父类加载器为扩展类加载器
- 它负责**加载环境变量 classpath 或系统属性 java.class.path 指定路径下的类库**
...
![image-20200705103516138](./assets/02.类加载子系统/876534b3c2f447d3fc33e6f1db218068.png)

sun.misc.Launcher 它是一个 java 虚拟机的入口应用

![image-20200705103636003](./assets/02.类加载子系统/a22114b608dffe484041b591d486a7fd.png)
...
![image-20200705105151258](./assets/02.类加载子系统/05fa27fcc38eeaaa5babff55a00882a3.png)
...
![image-20200705105810107](./assets/02.类加载子系统/bed320014f52bb27c8f3d795b3dc3b4a.png)
