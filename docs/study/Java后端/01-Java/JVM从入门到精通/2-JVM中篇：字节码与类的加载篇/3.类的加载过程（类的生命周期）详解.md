...
![image-20210430215050746](./assets/3.类的加载过程（类的生命周期）详解/b73db20eea59665fa3de67e1dec6d4e5.png)

其中，验证、准备、解析 3 个部分统称为链接（Linking）

从程序中类的使用过程看

![image-20210430215236716](./assets/3.类的加载过程（类的生命周期）详解/c6e5a63339bb2574b9b52a9ed14ee9c5.png)
...
![image-20210430221037898](./assets/3.类的加载过程（类的生命周期）详解/10969de50477655b954b23bfe550fb1d.png)
...
![image-20210430225015932](./assets/3.类的加载过程（类的生命周期）详解/b223d288b413f0ed0732357023a1dc7e.png)
...
![image-20210430235455086](./assets/3.类的加载过程（类的生命周期）详解/5aaa031ab1ffc8071fb92a32ead888ef.png)
