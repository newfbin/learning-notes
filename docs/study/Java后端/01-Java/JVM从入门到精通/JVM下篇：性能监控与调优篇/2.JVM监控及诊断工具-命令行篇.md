...
![image-20210504195803526](./assets/2.JVM监控及诊断工具-命令行篇/5b7c5d239e4da192ba65edb0800055c5.png)

![image-20210504195836342](./assets/2.JVM监控及诊断工具-命令行篇/fa3c5e41cbf999d261bcf32851731565.png)
...
![image-20210504201703222](./assets/2.JVM监控及诊断工具-命令行篇/83dddc874824b88d7fd03dab2b3889f1.png)
...
![img](./assets/2.JVM监控及诊断工具-命令行篇/9f2cea8b0a9b1bc47c10281b5c140cc4.png)

**jstat -compiler**

![img](./assets/2.JVM监控及诊断工具-命令行篇/4e11a07ce9b8ff2f73ba5585e11e1da3.png)

**jstat -printcompilation**

![img](./assets/2.JVM监控及诊断工具-命令行篇/2a2553eef35293d28ef095feee3bb3b7.png)

**jstat -gc**

![img](./assets/2.JVM监控及诊断工具-命令行篇/6ea2aa6665c49b4bd35d46152dd2f1aa.png)

**jstat -gccapacity**

![img](./assets/2.JVM监控及诊断工具-命令行篇/be1dbc9fb1100c4ab76fdf802171c000.png)

**jstat -gcutil**

![img](./assets/2.JVM监控及诊断工具-命令行篇/527f347102e0f48036f4e643103a735f.png)

**jstat -gccause**

![img](./assets/2.JVM监控及诊断工具-命令行篇/2e5d220a3ceb094b3d6aee8b46867942.png)

**jstat -gcnew**

![img](./assets/2.JVM监控及诊断工具-命令行篇/766a9d8c98c1add9ff60f001fcbe552b.png)

**jstat -gcnewcapacity**

![img](./assets/2.JVM监控及诊断工具-命令行篇/d26356900de541c149df9c00852245a1.png)

**jstat -gcold**

![img](./assets/2.JVM监控及诊断工具-命令行篇/64f18adec84996fec58edf7052440610.png)

**jstat -gcoldcapacity**

![img](./assets/2.JVM监控及诊断工具-命令行篇/52bf3b50ba4a48247742caa0aa30be7e.png)

**jstat -t**

![img](./assets/2.JVM监控及诊断工具-命令行篇/61a5c6b9c421ba9ec38db1f132ef4161.png)

**jstat -t -h**

![img](./assets/2.JVM监控及诊断工具-命令行篇/73a294c043f770940daa6a501c1e8d2c.png)
...
![image-20210504213044819](./assets/2.JVM监控及诊断工具-命令行篇/f3507ac3e24d40625f6c3d54c25c743b.png)
...
![image-20210504213301077](./assets/2.JVM监控及诊断工具-命令行篇/2225de448c4af005aa0f72e84bba5e57.png)
